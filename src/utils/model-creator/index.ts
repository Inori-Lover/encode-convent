...
import type { SagaConvertor } from "./convertor/saga";
import type { ReducerConvertor } from "./convertor/reducer";
import type {
...
>(model: {
  ...
  const allKeys = { ...effectKeys, ...reducerKeys };
